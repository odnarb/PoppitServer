...
# POST /user route for creating a company
# curl -w "\n" -H "X-Requested-With: XMLHttpRequest" -H "Content-Type: application/json" -X POST http://localhost:7777/appuser --data "{\"first_name\":\"Brandon\",\"last_name\":\"Chambers\",\"email_address\":\"bran.cham@gmail.com\",\"city\":\"Phoenix\",\"state\":\"AZ\"}"

curl -w "\n" -H "X-Requested-With: XMLHttpRequest" -H "Content-Type: application/json" -X POST http://localhost:7777/companyuser --data "{\"first_name\":\"Brandon\",\"last_name\":\"Chambers\",\"email_address\":\"bran.cham@gmail.com\"}"
