module.exports = (opts) => {
    ...
    module.user_registration_email = (opts) => {
        ...
        let confirmation_url = `${url}/companyuser/registration/confirm/${user.id}/${token}`;

        let html = `<p>Welcome, ${user.first_name}!<br />`
        ...
        html += `<p>Thank you, the ${process.env.APP_URL} team </p>`;
